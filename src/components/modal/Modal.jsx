        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="w-full  text-white bg-gradient-to-r from-pink-300 to-purple-400  hover:from-pink-300 hover:via-purple-300 hover:to-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 "
                >
                    Buy Now
                </button>
            </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal()}} type="button" className="focus:outline-none w-full text-white  text-white bg-gradient-to-r from-pink-300 to-purple-400  hover:from-pink-300 hover:via-purple-300 hover:to-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  ">Order Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
