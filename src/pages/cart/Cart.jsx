...
function Cart() {
  ...
  return (
    ...
    <h1 className="text-2xl font-bold text-center flex-grow  text-pink-600 ">Cart Items</h1>
    <button type="button"  onClick={clearCart} className="focus:outline-none  text-white bg-gradient-to-r from-pink-300 to-purple-400  hover:from-pink-300 hover:via-purple-300 hover:to-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 ">
      Clear Cart
    </button>
</div>
